...
class Link(models.Model):
    ...
    status = models.PositiveIntegerField(default=STATUS_DELETE, choices=STATUS_ITEMS, verbose_name="状态")
...
class SideBar(models.Model):
    # title-str     type-str    status-int     conten-str       created_time-str       owner-User
    STATUS_SHOW = 1
    STATUS_HIDE = 0
    STATUS_ITEM = (
        (STATUS_SHOW, '展示'),
    ...
    content = models.CharField(max_length=500, verbose_name="内容", help_text="如果不是html类型，可为空")
    owner = models.ForeignKey(User, verbose_name="作者")
    created_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
